import{j as e,_ as pe}from"./index-DM2jS1eP.js";import{r as s}from"./react-F9Y4d3HK.js";import{fetchClientById as L,subscribeClientUpdates as xe,fetchUpdateFeedback as H,updateClientUpdate as $,createUpdateFeedback as ge}from"./firebase-BmyISrpl.js";const R={planning:{label:"Planning",color:"#818CF8",bg:"rgba(129,140,248,0.13)",border:"rgba(129,140,248,0.28)",emoji:"📋"},"in-progress":{label:"In Progress",color:"#F59E0B",bg:"rgba(245,158,11,0.13)",border:"rgba(245,158,11,0.32)",emoji:"⚡"},review:{label:"Under Review",color:"#3B82F6",bg:"rgba(59,130,246,0.13)",border:"rgba(59,130,246,0.28)",emoji:"🔍"},completed:{label:"Completed",color:"#10B981",bg:"rgba(16,185,129,0.13)",border:"rgba(16,185,129,0.28)",emoji:"✅"},"on-hold":{label:"On Hold",color:"#EF4444",bg:"rgba(239,68,68,0.13)",border:"rgba(239,68,68,0.28)",emoji:"⏸️"}},T={seo:{label:"SEO & Search",subtitle:"Improving your visibility on Google and search engines",icon:"🔍",color:"#3B82F6",colorDim:"rgba(59,130,246,0.12)",colorBorder:"rgba(59,130,246,0.2)",grad:"linear-gradient(135deg, rgba(59,130,246,0.08) 0%, transparent 100%)"},"digital-marketing":{label:"Digital Marketing",subtitle:"Campaigns, ads, social media & brand growth",icon:"📣",color:"#8B5CF6",colorDim:"rgba(139,92,246,0.12)",colorBorder:"rgba(139,92,246,0.2)",grad:"linear-gradient(135deg, rgba(139,92,246,0.08) 0%, transparent 100%)"},general:{label:"Project Updates",subtitle:"Milestones and general progress updates",icon:"📋",color:"#6366F1",colorDim:"rgba(99,102,241,0.12)",colorBorder:"rgba(99,102,241,0.2)",grad:"linear-gradient(135deg, rgba(99,102,241,0.08) 0%, transparent 100%)"}};function he(){try{return localStorage.getItem("cp-theme")!=="light"}catch{return!0}}function be(t){try{localStorage.setItem("cp-theme",t?"dark":"light")}catch{}}const P=`
...
`;function U(t){return t.split(" ").filter(Boolean).map(o=>o[0]).join("").toUpperCase().slice(0,2)}function Y(t){if(!t)return"";try{return(t!=null&&t.toDate?t.toDate():new Date(t)).toLocaleDateString("en-US",{day:"numeric",month:"long",year:"numeric"})}catch{return""}}function O(t){if(!t)return"";try{return(t!=null&&t.toDate?t.toDate():new Date(t)).toLocaleDateString("en-US",{day:"numeric",month:"short"})}catch{return""}}function me(t){if(!t)return"";try{return(t!=null&&t.toDate?t.toDate():new Date(t)).toLocaleString("en-US",{day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"})}catch{return""}}function fe(){const t=new Date().getHours();return t<12?"Good morning":t<17?"Good afternoon":"Good evening"}function _({isDark:t,onToggle:o}){return e.jsxs("button",{className:"cp-toggle",onClick:o,"aria-label":t?"Switch to light":"Switch to dark",children:[e.jsxs("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 5px",pointerEvents:"none",fontSize:10},children:[e.jsx("span",{style:{opacity:t?.3:1,transition:"opacity .3s"},children:"☀"}),e.jsx("span",{style:{opacity:t?1:.3,transition:"opacity .3s"},children:"☽"})]}),e.jsx("div",{style:{position:"absolute",top:3,left:3,width:15,height:15,borderRadius:"50%",background:"linear-gradient(135deg,#6366F1,#818CF8)",transform:t?"translateX(21px)":"translateX(0)",transition:"transform 360ms cubic-bezier(.16,1,.3,1)",boxShadow:"0 1px 4px rgba(99,102,241,.4)"}})]})}function V({height:t=34,isDark:o=!0}){return e.jsx("a",{href:"/",className:"cp-logo-link","aria-label":"ZynHive",children:e.jsx("img",{src:"/logo.png",alt:"ZynHive",style:{height:t,width:"auto",objectFit:"contain",display:"block",...o?{}:{filter:"brightness(0) invert(1)",background:"rgba(8,11,20,.8)",borderRadius:8,padding:"3px 8px"}}})})}function Z(){return e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"100vh",gap:16},children:[e.jsxs("div",{style:{position:"relative",width:44,height:44},children:[e.jsx("div",{style:{position:"absolute",inset:0,borderRadius:"50%",border:"2px solid rgba(99,102,241,.15)"}}),e.jsx("div",{style:{position:"absolute",inset:0,borderRadius:"50%",border:"2px solid transparent",borderTopColor:"#6366F1",animation:"cp-spin .9s linear infinite"}}),e.jsx("div",{style:{position:"absolute",inset:6,borderRadius:"50%",background:"rgba(99,102,241,.1)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx("span",{style:{fontSize:10,fontWeight:800,color:"#6366F1"},children:"ZH"})})]}),e.jsx("span",{style:{fontSize:13,color:"var(--cp-text-dim)",fontWeight:500},children:"Loading your portal…"})]})}function G({status:t,color:o}){return e.jsx("span",{style:{display:"inline-block",width:8,height:8,borderRadius:"50%",background:o,flexShrink:0,...t==="in-progress"?{animation:"cp-pulse 1.8s ease infinite"}:{}}})}function ue({pct:t,color:o="#6366F1",size:c=96}){const m=(c-10)/2,i=2*Math.PI*m,g=i-t/100*i;return e.jsxs("svg",{width:c,height:c,style:{display:"block",transform:"rotate(-90deg)"},children:[e.jsx("circle",{cx:c/2,cy:c/2,r:m,fill:"none",stroke:"var(--cp-border)",strokeWidth:7}),e.jsx("circle",{cx:c/2,cy:c/2,r:m,fill:"none",stroke:o,strokeWidth:7,strokeLinecap:"round",strokeDasharray:i,strokeDashoffset:g,style:{transition:"stroke-dashoffset 1.2s cubic-bezier(.16,1,.3,1)"}})]})}function ye({clientId:t,onAuth:o,isDark:c,onToggleTheme:m}){const[i,g]=s.useState(""),[a,d]=s.useState(!1),[p,f]=s.useState(!1),[h,x]=s.useState(""),[z,y]=s.useState(!0),[w,S]=s.useState(!1);s.useEffect(()=>{L(t).then(v=>{v||S(!0)}).catch(()=>S(!0)).finally(()=>y(!1))},[t]);async function j(v){if(v.preventDefault(),!!i.trim()){f(!0),x("");try{const k=await L(t);if(!k){x("Portal not found.");return}if(k.password!==i.trim()){x("Incorrect password. Please try again.");return}sessionStorage.setItem(`client-auth-${t}`,"1"),o(k)}catch{x("Something went wrong. Please try again.")}finally{f(!1)}}}return z?e.jsx(Z,{}):w?e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"100vh",gap:12,padding:24,textAlign:"center"},children:[e.jsx("div",{style:{width:56,height:56,borderRadius:16,background:"rgba(239,68,68,.1)",border:"1px solid rgba(239,68,68,.2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:24},children:"🔍"}),e.jsx("p",{style:{fontSize:18,fontWeight:700,color:"var(--cp-text-h)"},children:"Portal not found"}),e.jsx("p",{style:{fontSize:14,color:"var(--cp-text-muted)",maxWidth:280,lineHeight:1.6},children:"This link is invalid or has been removed."})]}):e.jsxs("div",{className:"cp-dots-bg",style:{display:"flex",alignItems:"center",justifyContent:"center",minHeight:"100vh",padding:"24px 16px",position:"relative"},children:[e.jsx("div",{style:{position:"fixed",top:16,right:20,zIndex:100},children:e.jsx(_,{isDark:c,onToggle:m})}),e.jsx("div",{style:{position:"fixed",top:"18%",left:"50%",transform:"translateX(-50%)",width:480,height:480,borderRadius:"50%",background:"radial-gradient(circle, var(--cp-glow) 0%, transparent 70%)",pointerEvents:"none",animation:"cp-glow-an 4s ease infinite"}}),e.jsxs("div",{className:"cp-fade-up",style:{width:"100%",maxWidth:400,position:"relative",zIndex:1},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:32},children:[e.jsx("div",{style:{display:"flex",justifyContent:"center",marginBottom:20},children:e.jsx(V,{height:48,isDark:c})}),e.jsx("h1",{style:{fontSize:24,fontWeight:800,color:"var(--cp-text-h)",letterSpacing:"-0.5px",marginBottom:8},children:"Welcome Back"}),e.jsx("p",{style:{fontSize:14,color:"var(--cp-text-muted)",lineHeight:1.65},children:"Sign in to view your project progress and updates."})]}),e.jsx("div",{className:"cp-glass",style:{borderRadius:20,padding:"28px 28px 24px",boxShadow:"var(--cp-shadow-lg)"},children:e.jsxs("form",{onSubmit:j,style:{display:"flex",flexDirection:"column",gap:16},children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:6},children:[e.jsx("label",{style:{fontSize:11,fontWeight:700,color:"var(--cp-text-dim)",textTransform:"uppercase",letterSpacing:"0.07em"},children:"Password"}),e.jsxs("div",{style:{position:"relative"},children:[e.jsx("input",{type:a?"text":"password",value:i,onChange:v=>g(v.target.value),placeholder:"Enter your portal password",className:"cp-input",style:{width:"100%",padding:"11px 42px 11px 14px",borderRadius:11,fontSize:14,fontFamily:"inherit",border:"1.5px solid var(--cp-border)"},autoFocus:!0}),e.jsx("button",{type:"button",onClick:()=>d(v=>!v),style:{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",background:"transparent",border:"none",cursor:"pointer",color:"var(--cp-text-dim)",display:"flex",alignItems:"center",justifyContent:"center",padding:4},children:a?e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 20 20",fill:"none",children:[e.jsx("path",{d:"M2 10c2-4 5-6 8-6s6 2 8 6c-2 4-5 6-8 6s-6-2-8-6z",stroke:"currentColor",strokeWidth:"1.4"}),e.jsx("circle",{cx:"10",cy:"10",r:"2.5",stroke:"currentColor",strokeWidth:"1.4"}),e.jsx("path",{d:"M3 3l14 14",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"})]}):e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 20 20",fill:"none",children:[e.jsx("path",{d:"M2 10c2-4 5-6 8-6s6 2 8 6c-2 4-5 6-8 6s-6-2-8-6z",stroke:"currentColor",strokeWidth:"1.4"}),e.jsx("circle",{cx:"10",cy:"10",r:"2.5",stroke:"currentColor",strokeWidth:"1.4"})]})})]})]}),h&&e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,padding:"9px 12px",borderRadius:9,background:"rgba(239,68,68,.09)",border:"1px solid rgba(239,68,68,.22)"},children:[e.jsx("span",{style:{fontSize:14},children:"⚠️"}),e.jsx("span",{style:{fontSize:12,color:"#EF4444"},children:h})]}),e.jsx("button",{type:"submit",disabled:p||!i.trim(),className:"cp-btn",style:{padding:"12px 0",borderRadius:11,border:"none",background:p||!i.trim()?"rgba(99,102,241,.2)":"linear-gradient(135deg,#6366F1,#818CF8)",color:p||!i.trim()?"#4C5580":"white",fontSize:14,fontWeight:700,cursor:p||!i.trim()?"default":"pointer",width:"100%",display:"flex",alignItems:"center",justifyContent:"center",gap:8},children:p?e.jsxs(e.Fragment,{children:[e.jsx("span",{style:{width:16,height:16,borderRadius:"50%",border:"2px solid rgba(255,255,255,.25)",borderTopColor:"white",animation:"cp-spin .8s linear infinite",display:"inline-block"}})," Signing in…"]}):"Sign in to Portal →"})]})}),e.jsx("p",{style:{textAlign:"center",fontSize:11,color:"var(--cp-text-dimmer)",marginTop:20},children:"🔒 Secure · Encrypted · Private"})]})]})}function ve({client:t,isDark:o,onToggleTheme:c,onLogout:m,onOpenEmailSettings:i}){const[g,a]=s.useState(!1);return e.jsx("nav",{className:"cp-nav",children:e.jsxs("div",{className:"cp-nav-inner",style:{maxWidth:960,margin:"0 auto",padding:"0 20px",height:58,display:"flex",alignItems:"center",gap:10},children:[e.jsx(V,{isDark:o}),e.jsx("div",{style:{width:1,height:16,background:"var(--cp-border)"},className:"cp-hide-mobile"}),e.jsx("span",{className:"cp-hide-mobile",style:{fontSize:11,color:"var(--cp-text-dim)",fontWeight:500},children:"Client Portal"}),e.jsx("div",{style:{flex:1}}),e.jsx(_,{isDark:o,onToggle:c}),e.jsxs("button",{onClick:i,title:"Email notification settings",className:"cp-hide-tab",style:{display:"flex",alignItems:"center",gap:5,padding:"5px 10px",borderRadius:8,border:"1px solid var(--cp-border)",background:t.notificationEmail?"rgba(16,185,129,.08)":"transparent",color:t.notificationEmail?"#10B981":"var(--cp-text-dim)",cursor:"pointer",fontSize:11,transition:"all .15s",fontFamily:"inherit"},children:[e.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("rect",{x:"1",y:"3",width:"12",height:"8.5",rx:"1.5",stroke:"currentColor",strokeWidth:"1.1"}),e.jsx("path",{d:"M1 4l6 4 6-4",stroke:"currentColor",strokeWidth:"1.1",strokeLinecap:"round"})]}),t.notificationEmail?"Alerts On":"Email Alerts"]}),e.jsxs("div",{className:"cp-hide-mobile",style:{display:"flex",alignItems:"center",gap:10},children:[e.jsxs("div",{style:{textAlign:"right"},children:[e.jsx("div",{style:{fontSize:12,fontWeight:600,color:"var(--cp-text-body)",lineHeight:1.3},children:t.name}),t.company&&e.jsx("div",{style:{fontSize:10,color:"var(--cp-text-dim)"},children:t.company})]}),e.jsx("div",{style:{width:32,height:32,borderRadius:9,background:"linear-gradient(135deg,rgba(99,102,241,.28),rgba(129,140,248,.12))",border:"1px solid rgba(99,102,241,.22)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:800,color:"#818CF8",flexShrink:0},children:U(t.name)}),e.jsxs("button",{onClick:m,style:{display:"flex",alignItems:"center",gap:4,padding:"5px 9px",borderRadius:7,border:"1px solid var(--cp-border)",background:"transparent",color:"var(--cp-text-dim)",cursor:"pointer",fontSize:11,transition:"all .15s",fontFamily:"inherit"},onMouseEnter:d=>{const p=d.currentTarget;p.style.borderColor="rgba(239,68,68,.35)",p.style.color="#EF4444",p.style.background="rgba(239,68,68,.07)"},onMouseLeave:d=>{const p=d.currentTarget;p.style.borderColor="var(--cp-border)",p.style.color="var(--cp-text-dim)",p.style.background="transparent"},children:[e.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("path",{d:"M5 7h7M9.5 4.5L12 7l-2.5 2.5",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("path",{d:"M5 2H3a1 1 0 00-1 1v8a1 1 0 001 1h2",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),"Sign out"]})]}),e.jsxs("div",{style:{position:"relative"},className:"cp-show-mobile",children:[e.jsx("button",{onClick:()=>a(d=>!d),style:{display:"flex",alignItems:"center",justifyContent:"center",width:36,height:36,borderRadius:9,border:"1px solid var(--cp-border)",background:"var(--cp-bg-badge)",cursor:"pointer",color:"var(--cp-text-dim)"},children:e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",children:e.jsx("path",{d:"M2 4h10M2 7h10M2 10h10",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"})})}),g&&e.jsxs("div",{style:{position:"absolute",right:0,top:"calc(100% + 8px)",zIndex:999,background:"var(--cp-bg-glass)",border:"1px solid var(--cp-border)",borderRadius:12,padding:8,minWidth:200,boxShadow:"var(--cp-shadow-lg)",backdropFilter:"blur(16px)"},onClick:()=>a(!1),children:[e.jsxs("div",{style:{padding:"8px 12px",borderBottom:"1px solid var(--cp-border)",marginBottom:4},children:[e.jsx("div",{style:{fontSize:13,fontWeight:600,color:"var(--cp-text-h)"},children:t.name}),t.company&&e.jsx("div",{style:{fontSize:11,color:"var(--cp-text-dim)"},children:t.company})]}),e.jsxs("button",{onClick:i,style:{display:"flex",alignItems:"center",gap:8,width:"100%",padding:"9px 12px",borderRadius:8,border:"none",background:"transparent",color:"var(--cp-text-body)",cursor:"pointer",fontSize:13,textAlign:"left",fontFamily:"inherit"},children:[e.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("rect",{x:"1",y:"3",width:"12",height:"8.5",rx:"1.5",stroke:"currentColor",strokeWidth:"1.1"}),e.jsx("path",{d:"M1 4l6 4 6-4",stroke:"currentColor",strokeWidth:"1.1",strokeLinecap:"round"})]}),t.notificationEmail?"Email Alerts ✓":"Setup Email Alerts"]}),e.jsxs("button",{onClick:m,style:{display:"flex",alignItems:"center",gap:8,width:"100%",padding:"9px 12px",borderRadius:8,border:"none",background:"transparent",color:"#EF4444",cursor:"pointer",fontSize:13,textAlign:"left",fontFamily:"inherit"},children:[e.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("path",{d:"M5 7h7M9.5 4.5L12 7l-2.5 2.5",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("path",{d:"M5 2H3a1 1 0 00-1 1v8a1 1 0 001 1h2",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),"Sign out"]})]})]})]})})}function je({u:t,client:o,onClose:c,onApprove:m}){const[i,g]=s.useState(t),a=R[i.status],[d,p]=s.useState([]),[f,h]=s.useState(!0),[x,z]=s.useState(""),[y,w]=s.useState(!1),[S,j]=s.useState(!1),v=s.useRef(null);s.useEffect(()=>{i.id&&H(i.id).then(p).catch(()=>{}).finally(()=>h(!1))},[i.id]),s.useEffect(()=>{var n;(n=v.current)==null||n.scrollIntoView({behavior:"smooth"})},[d]),s.useEffect(()=>{function n(W){W.key==="Escape"&&c()}return window.addEventListener("keydown",n),()=>window.removeEventListener("keydown",n)},[c]),s.useEffect(()=>{const n=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=n}},[]);async function k(){const n=x.trim();if(!(!n||!i.id)){w(!0);try{await ge({updateId:i.id,clientId:o.id,message:n,fromClient:!0,senderName:o.name}),z(""),p(await H(i.id))}catch(W){console.error("[Feedback]",W)}finally{w(!1)}}}async function F(){if(!(!i.id||i.clientApproved||S)){j(!0);try{await $(i.id,{clientApproved:!0}),g(n=>({...n,clientApproved:!0})),m(i.id)}catch{}finally{j(!1)}}}return e.jsx("div",{className:"cp-modal-backdrop",onClick:c,children:e.jsxs("div",{className:"cp-modal",onClick:n=>n.stopPropagation(),children:[e.jsxs("div",{className:"cp-modal-header",style:{gap:12},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,flex:1,minWidth:0},children:[e.jsx("div",{style:{width:40,height:40,borderRadius:11,background:a.bg,border:`1px solid ${a.border}`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0},children:a.emoji}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsx("h2",{style:{fontSize:16,fontWeight:800,color:"var(--cp-text-h)",lineHeight:1.3,marginBottom:4,wordBreak:"break-word"},children:i.title}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:7,flexWrap:"wrap"},children:[e.jsx("span",{style:{fontSize:11,fontWeight:600,padding:"2px 9px",borderRadius:99,background:a.bg,color:a.color,border:`1px solid ${a.border}`},children:a.label}),i.phase&&e.jsxs("span",{style:{fontSize:11,color:"var(--cp-text-dim)"},children:["· ",i.phase]}),i.createdAt&&e.jsxs("span",{style:{fontSize:11,color:"var(--cp-text-dim)"},children:["· ",Y(i.createdAt)]}),i.clientApproved&&e.jsxs("span",{style:{fontSize:11,fontWeight:700,padding:"2px 8px",borderRadius:99,background:"rgba(16,185,129,.12)",color:"#10B981",border:"1px solid rgba(16,185,129,.25)",display:"flex",alignItems:"center",gap:4},children:[e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 10 10",fill:"none",children:e.jsx("path",{d:"M2 5l2.5 2.5L8 3",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})}),"Reviewed"]})]})]})]}),e.jsx("button",{onClick:c,style:{display:"flex",alignItems:"center",justifyContent:"center",width:32,height:32,borderRadius:9,border:"1px solid var(--cp-border)",background:"var(--cp-bg-badge)",color:"var(--cp-text-dim)",cursor:"pointer",flexShrink:0},children:e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 13 13",fill:"none",children:e.jsx("path",{d:"M2 2l9 9M11 2L2 11",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round"})})})]}),e.jsxs("div",{className:"cp-modal-body",style:{display:"flex",flexDirection:"column",gap:20},children:[i.imageUrl&&e.jsx("div",{children:e.jsx("img",{src:i.imageUrl,alt:"update",className:"cp-modal-img",style:{maxHeight:260}})}),i.description&&e.jsx("div",{style:{padding:"14px 16px",borderRadius:12,background:"var(--cp-bg-stat)",border:"1px solid var(--cp-border)"},children:e.jsx("p",{style:{fontSize:14,color:"var(--cp-text-body)",lineHeight:1.75},children:i.description})}),e.jsxs("div",{style:{padding:"16px",borderRadius:12,background:"var(--cp-bg-stat)",border:"1px solid var(--cp-border)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10},children:[e.jsx("span",{style:{fontSize:13,color:"var(--cp-text-muted)",fontWeight:600},children:"Task Progress"}),e.jsxs("span",{style:{fontSize:22,fontWeight:800,color:a.color,fontFamily:"monospace",lineHeight:1},children:[i.completionPercent,"%"]})]}),e.jsx("div",{style:{height:10,borderRadius:99,background:"var(--cp-border)",overflow:"hidden"},children:e.jsx("div",{style:{height:"100%",width:`${i.completionPercent}%`,borderRadius:99,background:`linear-gradient(90deg, ${a.color}, ${a.color}99)`,transition:"width .9s cubic-bezier(.16,1,.3,1)"}})}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginTop:8},children:[e.jsx("span",{style:{fontSize:11,color:"var(--cp-text-dim)"},children:"0%"}),e.jsxs("span",{style:{fontSize:11,color:a.color,fontWeight:600},children:[i.completionPercent,"% complete"]}),e.jsx("span",{style:{fontSize:11,color:"var(--cp-text-dim)"},children:"100%"})]})]}),i.clientApproved?e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,padding:"10px 14px",borderRadius:10,background:"rgba(16,185,129,.09)",border:"1px solid rgba(16,185,129,.22)",alignSelf:"flex-start"},children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none",style:{animation:"cp-checkpop .4s cubic-bezier(.16,1,.3,1)"},children:e.jsx("path",{d:"M3 8l3.5 3.5L13 4",stroke:"#10B981",strokeWidth:"2.2",strokeLinecap:"round",strokeLinejoin:"round"})}),e.jsx("span",{style:{fontSize:13,fontWeight:600,color:"#10B981"},children:"You reviewed this update"})]}):e.jsx("button",{onClick:F,disabled:S,className:"cp-done-btn",style:{alignSelf:"flex-start"},children:S?e.jsxs(e.Fragment,{children:[e.jsx("span",{style:{width:14,height:14,borderRadius:"50%",border:"2px solid rgba(16,185,129,.3)",borderTopColor:"#10B981",animation:"cp-spin .8s linear infinite",display:"inline-block"}})," Marking…"]}):e.jsxs(e.Fragment,{children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none",children:e.jsx("path",{d:"M3 8l3.5 3.5L13 4",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})," Mark as Reviewed"]})}),e.jsxs("div",{style:{borderTop:"1px solid var(--cp-border-md)",paddingTop:20},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,marginBottom:16},children:[e.jsx("svg",{width:"15",height:"15",viewBox:"0 0 16 16",fill:"none",children:e.jsx("path",{d:"M2 2h12v9H9l-3 3v-3H2V2z",stroke:"var(--cp-text-muted)",strokeWidth:"1.3",strokeLinejoin:"round"})}),e.jsx("span",{style:{fontSize:14,fontWeight:700,color:"var(--cp-text-h)"},children:"Conversation"}),d.length>0&&e.jsx("span",{style:{fontSize:10,fontWeight:700,padding:"1px 7px",borderRadius:99,background:"rgba(99,102,241,.12)",color:"#818CF8",border:"1px solid rgba(99,102,241,.22)"},children:d.length})]}),e.jsxs("div",{className:"cp-chat-wrap",style:{maxHeight:240,overflowY:"auto",paddingRight:2,marginBottom:14},children:[f?e.jsx("div",{style:{fontSize:13,color:"var(--cp-text-dim)",padding:"8px 0",textAlign:"center"},children:"Loading messages…"}):d.length===0?e.jsxs("div",{style:{textAlign:"center",padding:"20px 0"},children:[e.jsx("div",{style:{fontSize:24,marginBottom:8},children:"💬"}),e.jsx("p",{style:{fontSize:13,color:"var(--cp-text-dim)",lineHeight:1.6},children:"No messages yet. Ask a question or share your thoughts!"})]}):d.map(n=>e.jsxs("div",{className:`cp-bubble-row ${n.fromClient?"":"from-team"}`,children:[e.jsx("div",{className:"cp-bubble-avatar",style:{background:n.fromClient?"var(--cp-bg-stat)":"rgba(99,102,241,.15)",color:n.fromClient?"var(--cp-text-dim)":"#818CF8",border:`1px solid ${n.fromClient?"var(--cp-border)":"rgba(99,102,241,.22)"}`},children:n.fromClient?U(n.senderName||o.name):"ZH"}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:2,alignItems:n.fromClient?"flex-start":"flex-end"},children:[e.jsx("div",{className:`cp-bubble ${n.fromClient?"from-client":"from-team"}`,children:n.message}),e.jsxs("div",{className:"cp-bubble-meta",children:[n.fromClient?n.senderName||"You":n.senderName||"ZynHive Team"," · ",me(n.createdAt)]})]})]},n.id)),e.jsx("div",{ref:v})]}),e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"flex-end"},children:[e.jsx("textarea",{value:x,onChange:n=>z(n.target.value),onKeyDown:n=>{n.key==="Enter"&&!n.shiftKey&&(n.preventDefault(),k())},placeholder:"Ask a question or share your feedback…",rows:2,className:"cp-input",style:{flex:1,padding:"10px 14px",borderRadius:12,fontSize:13,fontFamily:"inherit",border:"1.5px solid var(--cp-border)",resize:"none",lineHeight:1.5}}),e.jsx("button",{onClick:k,disabled:y||!x.trim(),className:"cp-btn",style:{padding:"11px 16px",borderRadius:12,border:"none",flexShrink:0,background:y||!x.trim()?"rgba(99,102,241,.18)":"linear-gradient(135deg,#6366F1,#818CF8)",color:y||!x.trim()?"#4C5580":"white",fontSize:13,fontWeight:600,cursor:y||!x.trim()?"default":"pointer",fontFamily:"inherit"},children:y?e.jsx("span",{style:{width:15,height:15,borderRadius:"50%",border:"2px solid rgba(255,255,255,.2)",borderTopColor:"white",animation:"cp-spin .8s linear infinite",display:"inline-block"}}):e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none",children:e.jsx("path",{d:"M14 2L2 7l5 2 2 5L14 2z",stroke:"currentColor",strokeWidth:"1.5",strokeLinejoin:"round"})})})]}),e.jsx("p",{style:{fontSize:10,color:"var(--cp-text-dimmer)",marginTop:6},children:"Press Enter to send · Shift+Enter for new line"})]})]})]})})}function ke({u:t,isLatest:o,onClick:c,onApprove:m}){const i=R[t.status],[g,a]=s.useState(!1);async function d(p){if(p.stopPropagation(),!(!t.id||t.clientApproved||g)){a(!0);try{await $(t.id,{clientApproved:!0}),m(t.id)}catch{}finally{a(!1)}}}return e.jsxs("div",{className:`cp-card${o&&!t.clientApproved?" is-latest":""}${t.clientApproved?" is-approved":""}`,style:{position:"relative"},onClick:c,children:[e.jsx("div",{style:{position:"absolute",top:0,left:0,width:4,height:"100%",background:t.clientApproved?"#10B981":i.color,borderRadius:"16px 0 0 16px",opacity:t.clientApproved?.7:1}}),e.jsxs("div",{className:"cp-card-inner",style:{padding:"16px 18px 16px 22px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:12,marginBottom:10},children:[e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap",marginBottom:6},children:[t.clientApproved?e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none",style:{flexShrink:0},children:[e.jsx("circle",{cx:"8",cy:"8",r:"7",fill:"rgba(16,185,129,.15)",stroke:"#10B981",strokeWidth:"1.2"}),e.jsx("path",{d:"M5 8l2.5 2.5L11 5.5",stroke:"#10B981",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})]}):e.jsx(G,{status:t.status,color:i.color}),e.jsx("span",{style:{fontSize:15,fontWeight:700,color:"var(--cp-text-h)",lineHeight:1.3},children:t.title}),o&&!t.clientApproved&&e.jsx("span",{style:{fontSize:9,fontWeight:700,padding:"2px 7px",borderRadius:99,background:"rgba(99,102,241,.15)",color:"#818CF8",border:"1px solid rgba(99,102,241,.25)",textTransform:"uppercase",letterSpacing:"0.07em",flexShrink:0},children:"New"}),t.clientApproved&&e.jsx("span",{style:{fontSize:9,fontWeight:700,padding:"2px 7px",borderRadius:99,background:"rgba(16,185,129,.12)",color:"#10B981",border:"1px solid rgba(16,185,129,.22)",textTransform:"uppercase",letterSpacing:"0.07em",flexShrink:0},children:"Reviewed"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"},children:[e.jsxs("span",{style:{fontSize:11,fontWeight:600,padding:"2px 9px",borderRadius:99,background:i.bg,color:i.color,border:`1px solid ${i.border}`},children:[i.emoji," ",i.label]}),t.phase&&e.jsxs("span",{style:{fontSize:11,color:"var(--cp-text-dim)"},children:["· ",t.phase]})]})]}),t.createdAt&&e.jsx("span",{style:{fontSize:11,color:"var(--cp-text-dim)",flexShrink:0,marginTop:2},children:O(t.createdAt)})]}),t.description&&e.jsx("p",{style:{fontSize:13,color:"var(--cp-text-muted)",lineHeight:1.7,marginBottom:12,display:"-webkit-box",WebkitLineClamp:2,WebkitBoxOrient:"vertical",overflow:"hidden"},children:t.description}),t.imageUrl&&e.jsx("div",{style:{marginBottom:12},children:e.jsx("img",{src:t.imageUrl,alt:"attachment",style:{width:"100%",borderRadius:9,display:"block",border:"1px solid var(--cp-border-md)",maxHeight:180,objectFit:"cover"}})}),e.jsxs("div",{style:{marginBottom:14},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:6},children:[e.jsx("span",{style:{fontSize:11,color:"var(--cp-text-dim)",fontWeight:500},children:"Progress"}),e.jsxs("span",{style:{fontSize:12,fontWeight:800,color:t.clientApproved?"#10B981":i.color,fontFamily:"monospace"},children:[t.completionPercent,"%"]})]}),e.jsx("div",{style:{height:6,borderRadius:99,background:"var(--cp-border)",overflow:"hidden"},children:e.jsx("div",{style:{height:"100%",width:`${t.completionPercent}%`,borderRadius:99,background:`linear-gradient(90deg, ${t.clientApproved?"#10B981":i.color}, ${t.clientApproved?"#10B981":i.color}99)`,transition:"width .9s cubic-bezier(.16,1,.3,1)"}})})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:10},children:[e.jsx("span",{style:{fontSize:11,color:"var(--cp-text-dim)"},children:"Click to view details & give feedback"}),t.clientApproved?e.jsxs("span",{style:{fontSize:11,color:"#10B981",fontWeight:600,display:"flex",alignItems:"center",gap:4,flexShrink:0},children:[e.jsx("svg",{width:"11",height:"11",viewBox:"0 0 16 16",fill:"none",children:e.jsx("path",{d:"M3 8l3.5 3.5L13 4",stroke:"currentColor",strokeWidth:"2.2",strokeLinecap:"round",strokeLinejoin:"round"})}),"Reviewed"]}):e.jsx("button",{onClick:d,disabled:g,className:"cp-done-btn",style:{padding:"7px 13px",fontSize:12,flexShrink:0,alignSelf:"flex-end"},children:g?e.jsx("span",{style:{width:12,height:12,borderRadius:"50%",border:"2px solid rgba(16,185,129,.3)",borderTopColor:"#10B981",animation:"cp-spin .8s linear infinite",display:"inline-block"}}):e.jsxs(e.Fragment,{children:[e.jsx("svg",{width:"11",height:"11",viewBox:"0 0 16 16",fill:"none",children:e.jsx("path",{d:"M3 8l3.5 3.5L13 4",stroke:"currentColor",strokeWidth:"2.2",strokeLinecap:"round",strokeLinejoin:"round"})})," Mark Reviewed"]})})]})]})]})}function we({sectionKey:t,items:o,latestId:c,onCardClick:m,onApprove:i,collapsed:g,onToggle:a}){const d=T[t],p=o.filter(x=>x.status==="completed").length,f=o.filter(x=>x.clientApproved).length,h=o.length>0?Math.round(p/o.length*100):0;return e.jsxs("div",{children:[e.jsxs("div",{className:"cp-section-banner cp-section-hdr",style:{background:d.grad},onClick:a,children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:14},children:[e.jsx("div",{style:{width:42,height:42,borderRadius:11,background:d.colorDim,border:`1px solid ${d.colorBorder}`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0},children:d.icon}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:4,flexWrap:"wrap"},children:[e.jsx("h2",{style:{fontSize:15,fontWeight:800,color:"var(--cp-text-h)",letterSpacing:"-0.2px"},children:d.label}),e.jsxs("span",{style:{fontSize:10,fontWeight:700,padding:"2px 8px",borderRadius:99,background:d.colorDim,color:d.color,border:`1px solid ${d.colorBorder}`},children:[o.length," ",o.length===1?"task":"tasks"]}),f>0&&e.jsxs("span",{style:{fontSize:10,fontWeight:700,padding:"2px 8px",borderRadius:99,background:"rgba(16,185,129,.1)",color:"#10B981",border:"1px solid rgba(16,185,129,.2)"},children:[f," reviewed"]})]}),e.jsx("p",{style:{fontSize:12,color:"var(--cp-text-muted)",lineHeight:1.5},children:d.subtitle})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,flexShrink:0},children:[e.jsxs("div",{style:{textAlign:"center"},className:"cp-hide-mobile",children:[e.jsxs("div",{style:{fontSize:18,fontWeight:800,color:d.color,fontFamily:"monospace",lineHeight:1},children:[h,"%"]}),e.jsx("div",{style:{fontSize:10,color:"var(--cp-text-dim)",marginTop:2},children:"done"})]}),e.jsx("div",{className:`cp-chevron ${g?"closed":"open"}`,children:e.jsx("svg",{width:"10",height:"10",viewBox:"0 0 10 10",fill:"none",children:e.jsx("path",{d:"M2 3.5l3 3 3-3",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})]})]}),!g&&e.jsxs("div",{style:{marginTop:14},children:[e.jsx("div",{style:{height:4,borderRadius:99,background:"var(--cp-border)",overflow:"hidden"},children:e.jsx("div",{style:{height:"100%",width:`${h}%`,borderRadius:99,background:`linear-gradient(90deg, ${d.color}, ${d.color}99)`,transition:"width 1s cubic-bezier(.16,1,.3,1)"}})}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginTop:5},children:[e.jsxs("span",{style:{fontSize:10,color:"var(--cp-text-dim)"},children:[p," of ",o.length," completed"]}),e.jsxs("span",{style:{fontSize:10,color:d.color,fontWeight:600},children:[o.length-p," remaining"]})]})]})]}),!g&&e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:o.map(x=>e.jsx(ke,{u:x,isLatest:x.id===c,onClick:()=>m(x),onApprove:i},x.id))})]})}function Se({notif:t,onDismiss:o}){return s.useEffect(()=>{const c=setTimeout(o,6e3);return()=>clearTimeout(c)},[o]),e.jsxs("div",{className:"cp-notif-popup",children:[e.jsx("div",{style:{width:36,height:36,borderRadius:10,background:"rgba(99,102,241,0.15)",border:"1px solid rgba(99,102,241,0.25)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0},children:"🔔"}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsx("div",{style:{fontSize:10,fontWeight:700,color:"#818CF8",textTransform:"uppercase",letterSpacing:"0.07em",marginBottom:3},children:"New Update"}),e.jsx("div",{style:{fontSize:13,fontWeight:700,color:"var(--cp-text-h)",marginBottom:3,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:t.title}),t.message&&e.jsx("div",{style:{fontSize:12,color:"var(--cp-text-muted)",lineHeight:1.5,overflow:"hidden",display:"-webkit-box",WebkitLineClamp:2,WebkitBoxOrient:"vertical"},children:t.message})]}),e.jsx("button",{className:"cp-notif-dismiss",onClick:o,children:"×"})]})}function Ce({client:t,isDark:o,onToggleTheme:c,onLogout:m}){const[i,g]=s.useState(t),[a,d]=s.useState([]),[p,f]=s.useState(!0),[h,x]=s.useState(null),[z,y]=s.useState(!1),[w,S]=s.useState(t.notificationEmail??""),[j,v]=s.useState(!1),[k,F]=s.useState([]),[n,W]=s.useState("all"),[I,E]=s.useState("sections"),[X,K]=s.useState(!1),[q,J]=s.useState(new Set),Q=s.useCallback(r=>F(l=>l.filter(b=>b.id!==r)),[]);function ee(r){J(l=>{const b=new Set(l);return b.has(r)?b.delete(r):b.add(r),b})}const D=s.useCallback(r=>{d(l=>l.map(b=>b.id===r?{...b,clientApproved:!0}:b)),(h==null?void 0:h.id)===r&&x(l=>l&&{...l,clientApproved:!0})},[h==null?void 0:h.id]);s.useEffect(()=>xe(i.id,l=>{d(l),f(!1)},l=>{const b=l.id??Date.now().toString();F(A=>[...A,{id:b,title:l.title,message:l.description}])}),[i.id]);async function te(){if(i.id){v(!0);try{const{updateClient:r}=await pe(async()=>{const{updateClient:l}=await import("./firebase-BmyISrpl.js");return{updateClient:l}},[]);await r(i.id,{notificationEmail:w.trim()}),g(l=>({...l,notificationEmail:w.trim()})),y(!1)}catch{}finally{v(!1)}}}const u=a[0],re=a.filter(r=>r.status==="completed").length,ie=a.filter(r=>r.status==="in-progress").length,oe=a.filter(r=>r.clientApproved).length,M=(u==null?void 0:u.completionPercent)??0,N=a.filter(r=>!r.clientApproved).length,C=a.filter(r=>n==="needs-review"?!r.clientApproved:n==="in-progress"?r.status==="in-progress":n==="completed"?r.status==="completed":!0),ne=C.filter(r=>r.category==="seo"),se=C.filter(r=>r.category==="digital-marketing"),ae=C.filter(r=>!r.category||r.category==="general"),le=[{key:"seo",items:ne},{key:"digital-marketing",items:se},{key:"general",items:ae}].filter(r=>r.items.length>0),B=u?R[u.status]:null,de=[{key:"all",label:"All Updates",icon:"📋"},{key:"needs-review",label:"Needs Review",icon:"👀"},{key:"in-progress",label:"In Progress",icon:"⚡"},{key:"completed",label:"Completed",icon:"✅"}];return e.jsxs("div",{className:"cp-fade-in",style:{minHeight:"100vh"},children:[h&&e.jsx(je,{u:h,client:i,onClose:()=>x(null),onApprove:D}),k.length>0&&e.jsx("div",{style:{position:"fixed",bottom:24,right:16,zIndex:9999,display:"flex",flexDirection:"column",gap:10,alignItems:"flex-end"},children:k.map(r=>e.jsx(Se,{notif:r,onDismiss:()=>Q(r.id)},r.id))}),z&&e.jsx("div",{className:"cp-modal-backdrop",onClick:()=>y(!1),children:e.jsxs("div",{className:"cp-modal",style:{maxWidth:420},onClick:r=>r.stopPropagation(),children:[e.jsxs("div",{className:"cp-modal-header",style:{gap:10},children:[e.jsx("span",{style:{fontSize:22},children:"📧"}),e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:15,fontWeight:800,color:"var(--cp-text-h)"},children:"Email Notifications"}),e.jsx("div",{style:{fontSize:11,color:"var(--cp-text-dim)",marginTop:2},children:"Get emailed when your project has a new update"})]}),e.jsx("button",{onClick:()=>y(!1),style:{display:"flex",alignItems:"center",justifyContent:"center",width:32,height:32,borderRadius:8,border:"1px solid var(--cp-border)",background:"var(--cp-bg-badge)",color:"var(--cp-text-dim)",cursor:"pointer"},children:e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 13 13",fill:"none",children:e.jsx("path",{d:"M2 2l9 9M11 2L2 11",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round"})})})]}),e.jsxs("div",{className:"cp-modal-body",style:{display:"flex",flexDirection:"column",gap:14},children:[e.jsx("p",{style:{fontSize:13,color:"var(--cp-text-muted)",lineHeight:1.7,margin:0},children:"Enter your email and we'll send you a notification whenever a new update is posted to your project."}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:6},children:[e.jsx("label",{style:{fontSize:11,fontWeight:700,color:"var(--cp-text-dim)",textTransform:"uppercase",letterSpacing:"0.07em"},children:"Your Email"}),e.jsx("input",{type:"email",value:w,onChange:r=>S(r.target.value),placeholder:"you@example.com",className:"cp-input",style:{width:"100%",padding:"11px 14px",borderRadius:10,fontSize:13,fontFamily:"inherit",border:"1.5px solid var(--cp-border)"}})]}),e.jsxs("div",{style:{display:"flex",gap:10,marginTop:4},children:[e.jsx("button",{onClick:()=>y(!1),style:{flex:1,padding:"11px 0",borderRadius:10,border:"1px solid var(--cp-border)",background:"transparent",color:"var(--cp-text-muted)",cursor:"pointer",fontSize:13,fontFamily:"inherit"},children:"Cancel"}),e.jsx("button",{onClick:te,disabled:j,className:"cp-btn",style:{flex:1,padding:"11px 0",borderRadius:10,border:"none",background:j?"rgba(99,102,241,.2)":"linear-gradient(135deg,#6366F1,#818CF8)",color:j?"#4C5580":"white",cursor:j?"default":"pointer",fontSize:13,fontWeight:600,fontFamily:"inherit"},children:j?"Saving…":"Save"})]})]})]})}),e.jsx(ve,{client:i,isDark:o,onToggleTheme:c,onLogout:m,onOpenEmailSettings:()=>y(!0)}),e.jsx("div",{style:{background:"var(--cp-bg-hero)",borderBottom:"1px solid var(--cp-border-md)",transition:"background .3s,border-color .3s"},children:e.jsx("div",{className:"cp-hero-inner",style:{maxWidth:960,margin:"0 auto",padding:"28px 24px 24px"},children:e.jsxs("div",{className:"cp-hero-cols cp-fade-up",style:{display:"flex",alignItems:"center",gap:24},children:[e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsxs("p",{style:{fontSize:13,color:"var(--cp-text-dim)",fontWeight:500,marginBottom:5},children:[fe(),", ",i.name.split(" ")[0],"! 👋"]}),e.jsx("h1",{style:{fontSize:22,fontWeight:800,color:"var(--cp-text-h)",letterSpacing:"-0.4px",lineHeight:1.25,marginBottom:8},children:i.projectName||"Your Project Dashboard"}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap",marginBottom:14},children:[i.company&&e.jsxs("span",{style:{fontSize:12,color:"var(--cp-text-dim)",display:"flex",alignItems:"center",gap:4},children:[e.jsxs("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("rect",{x:"2",y:"5",width:"10",height:"7",rx:"1",stroke:"currentColor",strokeWidth:"1.2"}),e.jsx("path",{d:"M5 5V4a2 2 0 014 0v1",stroke:"currentColor",strokeWidth:"1.2"})]}),i.company]}),(u==null?void 0:u.createdAt)&&e.jsxs("span",{style:{fontSize:11,color:"var(--cp-text-dim)",display:"flex",alignItems:"center",gap:4},children:[e.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 12 12",fill:"none",children:[e.jsx("circle",{cx:"6",cy:"6",r:"5",stroke:"currentColor",strokeWidth:"1.1"}),e.jsx("path",{d:"M6 3.5V6l1.5 1.5",stroke:"currentColor",strokeWidth:"1.1",strokeLinecap:"round"})]}),"Last updated ",Y(u.createdAt)]})]}),u&&B&&e.jsxs("div",{style:{display:"inline-flex",alignItems:"center",gap:8,padding:"8px 14px",borderRadius:10,background:"var(--cp-bg-badge)",border:"1px solid var(--cp-border)",fontSize:12},children:[e.jsx(G,{status:u.status,color:B.color}),e.jsx("span",{style:{color:"var(--cp-text-muted)"},children:"Latest: "}),e.jsx("span",{style:{color:"var(--cp-text-h)",fontWeight:600},children:u.title}),e.jsx("span",{style:{padding:"1px 7px",borderRadius:99,background:B.bg,color:B.color,border:`1px solid ${B.border}`,fontSize:10,fontWeight:700},children:B.label})]})]}),a.length>0&&e.jsxs("div",{className:"cp-ring-col",style:{flexShrink:0,display:"flex",flexDirection:"column",alignItems:"center",gap:4},children:[e.jsxs("div",{style:{position:"relative",width:96,height:96},children:[e.jsx(ue,{pct:M,size:96,color:"#6366F1"}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:e.jsxs("span",{style:{fontSize:18,fontWeight:800,color:"#818CF8",fontFamily:"monospace",lineHeight:1},children:[M,"%"]})})]}),e.jsxs("span",{style:{fontSize:10,color:"var(--cp-text-dim)",fontWeight:500,textAlign:"center",lineHeight:1.4},children:["Overall",e.jsx("br",{}),"Progress"]})]})]})})}),a.length>0&&e.jsx("div",{style:{borderBottom:"1px solid var(--cp-border-md)",transition:"border-color .3s"},children:e.jsx("div",{style:{maxWidth:960,margin:"0 auto",padding:"18px 20px"},children:e.jsx("div",{className:"cp-metrics-grid cp-fade-up cp-d1",style:{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:12},children:[{label:"Total",value:a.length,color:"#6366F1",icon:"📋",sub:"updates"},{label:"Completed",value:re,color:"#10B981",icon:"✅",sub:"tasks done"},{label:"In Progress",value:ie,color:"#F59E0B",icon:"⚡",sub:"active"},{label:"You Reviewed",value:oe,color:"#3B82F6",icon:"👍",sub:"approved"}].map(({label:r,value:l,color:b,icon:A,sub:ce})=>e.jsxs("div",{className:"cp-metric",children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8},children:[e.jsx("span",{style:{fontSize:18},children:A}),e.jsx("span",{style:{fontSize:22,fontWeight:800,color:b,fontFamily:"monospace",lineHeight:1},children:l})]}),e.jsx("div",{style:{fontSize:12,fontWeight:600,color:"var(--cp-text-body)"},children:r}),e.jsx("div",{style:{fontSize:10,color:"var(--cp-text-dim)",marginTop:2},children:ce})]},r))})})}),e.jsx("div",{className:"cp-content",style:{maxWidth:960,margin:"0 auto",padding:"24px 20px 80px"},children:p?e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",paddingTop:72,gap:14},children:[e.jsx("div",{style:{width:34,height:34,borderRadius:"50%",border:"2px solid rgba(99,102,241,.15)",borderTopColor:"#6366F1",animation:"cp-spin .9s linear infinite"}}),e.jsx("span",{style:{fontSize:13,color:"var(--cp-text-dim)",fontWeight:500},children:"Loading your updates…"})]}):a.length===0?e.jsxs("div",{className:"cp-fade-up",style:{textAlign:"center",paddingTop:80},children:[e.jsx("div",{style:{width:76,height:76,borderRadius:20,background:"rgba(99,102,241,.07)",border:"1px solid rgba(99,102,241,.14)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:32,margin:"0 auto 20px"},children:"🚀"}),e.jsx("p",{style:{fontSize:18,fontWeight:700,color:"var(--cp-text-h)",marginBottom:10},children:"Your project has kicked off!"}),e.jsx("p",{style:{fontSize:14,color:"var(--cp-text-muted)",lineHeight:1.7,maxWidth:300,margin:"0 auto"},children:"Updates will appear here as the team completes work on your project."})]}):e.jsxs(e.Fragment,{children:[N>0&&!X&&e.jsxs("div",{className:"cp-alert-banner",children:[e.jsx("span",{style:{fontSize:20,flexShrink:0},children:"👀"}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsxs("span",{style:{fontSize:13,fontWeight:700,color:"#D97706"},children:[N," ",N===1?"update needs":"updates need"," your review"]}),e.jsx("p",{style:{fontSize:12,color:"var(--cp-text-muted)",marginTop:2,lineHeight:1.5},children:`Open each update, read through it, and click "Mark as Reviewed" to let the team know you've seen it.`})]}),e.jsx("button",{onClick:()=>K(!0),style:{background:"transparent",border:"none",cursor:"pointer",color:"var(--cp-text-dim)",fontSize:18,lineHeight:1,flexShrink:0,padding:4,borderRadius:6,display:"flex",alignItems:"center",justifyContent:"center"},children:"×"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:12,marginBottom:24,flexWrap:"wrap"},children:[e.jsx("div",{className:"cp-filter-bar",style:{flex:1},children:de.map(r=>e.jsxs("button",{className:`cp-filter-tab${n===r.key?" cp-tab-active":""}`,onClick:()=>W(r.key),children:[e.jsx("span",{children:r.icon}),r.label,r.key!=="all"&&e.jsx("span",{style:{padding:"0 5px",borderRadius:99,background:"rgba(99,102,241,.1)",fontSize:10,fontWeight:700,color:n===r.key?"#818CF8":"var(--cp-text-dim)"},children:r.key==="needs-review"?a.filter(l=>!l.clientApproved).length:r.key==="in-progress"?a.filter(l=>l.status==="in-progress").length:a.filter(l=>l.status==="completed").length})]},r.key))}),e.jsxs("div",{style:{display:"flex",gap:6,flexShrink:0},children:[e.jsxs("button",{className:`cp-view-btn${I==="sections"?" cp-tab-active":""}`,onClick:()=>E("sections"),children:[e.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 12 12",fill:"none",children:[e.jsx("rect",{x:"1",y:"1",width:"10",height:"3",rx:"1",stroke:"currentColor",strokeWidth:"1.2"}),e.jsx("rect",{x:"1",y:"5.5",width:"10",height:"3",rx:"1",stroke:"currentColor",strokeWidth:"1.2"})]}),"Sections"]}),e.jsxs("button",{className:`cp-view-btn${I==="timeline"?" cp-tab-active":""}`,onClick:()=>E("timeline"),children:[e.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 12 12",fill:"none",children:[e.jsx("circle",{cx:"2",cy:"2.5",r:"1",fill:"currentColor"}),e.jsx("line",{x1:"4",y1:"2.5",x2:"11",y2:"2.5",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round"}),e.jsx("circle",{cx:"2",cy:"6",r:"1",fill:"currentColor"}),e.jsx("line",{x1:"4",y1:"6",x2:"11",y2:"6",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round"}),e.jsx("circle",{cx:"2",cy:"9.5",r:"1",fill:"currentColor"}),e.jsx("line",{x1:"4",y1:"9.5",x2:"11",y2:"9.5",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round"})]}),"Timeline"]})]})]}),C.length===0&&e.jsxs("div",{className:"cp-fade-up",style:{textAlign:"center",paddingTop:48},children:[e.jsx("div",{style:{fontSize:36,marginBottom:12},children:"🔍"}),e.jsx("p",{style:{fontSize:16,fontWeight:700,color:"var(--cp-text-h)",marginBottom:8},children:"No updates match this filter"}),e.jsx("button",{onClick:()=>W("all"),style:{padding:"8px 18px",borderRadius:99,border:"1px solid rgba(99,102,241,.3)",background:"rgba(99,102,241,.08)",color:"#818CF8",fontSize:13,fontWeight:600,cursor:"pointer",fontFamily:"inherit"},children:"View all updates"})]}),I==="timeline"&&C.length>0&&e.jsx("div",{className:"cp-timeline-wrap cp-fade-in",children:C.map(r=>{const l=R[r.status];return e.jsxs("div",{className:"cp-timeline-item",onClick:()=>x(r),children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:4,paddingTop:2,flexShrink:0},children:[e.jsx("div",{style:{width:10,height:10,borderRadius:"50%",background:r.clientApproved?"#10B981":l.color,...r.status==="in-progress"?{animation:"cp-pulse 1.8s ease infinite"}:{}}}),e.jsx("div",{style:{flex:1,width:1,background:"var(--cp-border)",minHeight:24}})]}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:10,marginBottom:6},children:[e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:7,flexWrap:"wrap",marginBottom:4},children:[e.jsx("span",{style:{fontSize:14,fontWeight:700,color:"var(--cp-text-h)",lineHeight:1.3},children:r.title}),r.clientApproved&&e.jsx("span",{style:{fontSize:9,fontWeight:700,padding:"1px 6px",borderRadius:99,background:"rgba(16,185,129,.1)",color:"#10B981",border:"1px solid rgba(16,185,129,.2)",flexShrink:0},children:"Reviewed"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"},children:[e.jsxs("span",{style:{fontSize:11,fontWeight:600,padding:"1px 8px",borderRadius:99,background:l.bg,color:l.color,border:`1px solid ${l.border}`},children:[l.emoji," ",l.label]}),r.phase&&e.jsxs("span",{style:{fontSize:11,color:"var(--cp-text-dim)"},children:["· ",r.phase]}),(()=>{const b=r.category&&r.category!=="general"?T[r.category]:T.general;return e.jsxs("span",{style:{fontSize:11,color:"var(--cp-text-dim)"},children:["· ",b.icon," ",b.label]})})()]})]}),e.jsxs("div",{style:{textAlign:"right",flexShrink:0},children:[e.jsxs("div",{style:{fontSize:13,fontWeight:800,color:r.clientApproved?"#10B981":l.color,fontFamily:"monospace"},children:[r.completionPercent,"%"]}),r.createdAt&&e.jsx("div",{style:{fontSize:10,color:"var(--cp-text-dim)",marginTop:2},children:O(r.createdAt)})]})]}),r.description&&e.jsx("p",{style:{fontSize:12,color:"var(--cp-text-muted)",lineHeight:1.65,overflow:"hidden",display:"-webkit-box",WebkitLineClamp:1,WebkitBoxOrient:"vertical"},children:r.description})]})]},r.id)})}),I==="sections"&&C.length>0&&e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:36},children:le.map(({key:r,items:l},b)=>e.jsx("div",{className:`cp-fade-up cp-d${Math.min(b+2,6)}`,children:e.jsx(we,{sectionKey:r,items:l,latestId:u==null?void 0:u.id,onCardClick:x,onApprove:D,collapsed:q.has(r),onToggle:()=>ee(r)})},r))})]})}),e.jsx("footer",{className:"cp-footer",style:{padding:"20px 24px"},children:e.jsxs("div",{style:{maxWidth:960,margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[e.jsx("div",{style:{width:20,height:20,borderRadius:6,background:"linear-gradient(135deg,#6366F1,#818CF8)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx("span",{style:{fontSize:7,fontWeight:800,color:"white"},children:"ZH"})}),e.jsxs("span",{style:{fontSize:12,color:"var(--cp-text-dim)"},children:["Powered by ",e.jsx("strong",{style:{color:"var(--cp-text-muted)"},children:"ZynHive"})]})]}),e.jsx("span",{style:{fontSize:11,color:"var(--cp-text-dimmer)"},children:"🔒 Secure Client Portal"})]})})]})}function Fe(){const t=window.location.pathname.split("/")[2]??"",[o,c]=s.useState(null),[m,i]=s.useState(!0),[g,a]=s.useState(he);function d(){a(f=>(be(!f),!f))}s.useEffect(()=>{sessionStorage.getItem(`client-auth-${t}`)==="1"&&t?L(t).then(h=>{h&&c(h)}).catch(()=>{}).finally(()=>i(!1)):i(!1)},[t]);function p(){sessionStorage.removeItem(`client-auth-${t}`),c(null)}return s.useEffect(()=>{const f=document.createElement("style");return f.textContent=".cp-show-mobile { display: none; } @media (max-width: 640px) { .cp-show-mobile { display: flex !important; } }",document.head.appendChild(f),()=>{document.head.removeChild(f)}},[]),t?e.jsxs(e.Fragment,{children:[e.jsx("style",{children:P}),e.jsx("div",{className:"cp-root","data-cp-theme":g?"dark":"light",children:m?e.jsx(Z,{}):o?e.jsx(Ce,{client:o,isDark:g,onToggleTheme:d,onLogout:p}):e.jsx(ye,{clientId:t,onAuth:c,isDark:g,onToggleTheme:d})})]}):e.jsxs(e.Fragment,{children:[e.jsx("style",{children:P}),e.jsx("div",{className:"cp-root","data-cp-theme":g?"dark":"light",style:{display:"flex",alignItems:"center",justifyContent:"center",minHeight:"100vh"},children:e.jsx("p",{style:{color:"var(--cp-text-muted)",fontSize:14},children:"Invalid portal link."})})]})}export{Fe as ClientPage};
