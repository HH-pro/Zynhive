...
// ── Status colors ─────────────────────────────────────────────────────────────
// Keyed on FirestoreLead["status"] values only — no phantom statuses
export const STATUS_COLORS: Record<
  LeadStatus,
  { bg: string; text: string; border: string }
> = {
  new:       { bg: "rgba(59,110,248,0.08)",  text: "#7dd3fc", border: "rgba(59,110,248,0.2)"  },
  contacted: { bg: "rgba(13,191,168,0.08)",  text: "#5eead4", border: "rgba(13,191,168,0.2)"  },
  qualified: { bg: "rgba(34,197,94,0.08)",   text: "#86efac", border: "rgba(34,197,94,0.2)"   },
  proposal:  { bg: "rgba(245,158,11,0.08)",  text: "#fde68a", border: "rgba(245,158,11,0.2)"  },
  closed:    { bg: "rgba(34,197,94,0.08)",   text: "#4ade80", border: "rgba(34,197,94,0.25)"  },
  lost:      { bg: "rgba(107,114,128,0.08)", text: "#9ca3af", border: "rgba(107,114,128,0.2)" },
};
...
// ── Mail status colors — keyed on FollowUpKey + "none" ────────────────────────
export const MAIL_STATUS_COLORS: Record<
  string,
  { bg: string; text: string; border: string }
> = {
...
// Re-export for convenience — components can import these from here or types/leads
export type { FollowUpStep, LeadStatus, LeadSource };