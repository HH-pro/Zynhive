...
export function AdminLogin({ onSuccess }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Ambient glow */}
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[520px] h-[420px] pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse, rgba(59,130,246,0.09) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-[400px]">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <div className="relative w-10 h-10">
              ...
              />
              <div
                className="absolute inset-[3px] rounded-lg rotate-45"
                style={{ background: "var(--bg)" }}
              />
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="relative">
                ...
                >
                  {showPw ? (
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                      <path
                        d="M2 2l10 10M5.5 4.5A5 5 0 0112 7a5.5 5.5 0 01-1 1.4M2 7a5 5 0 014.5-4.9"
                        stroke="currentColor"
                        strokeWidth="1"
                        strokeLinecap="round"
                      />
            ...
            <button
              type="submit"
              disabled={loading}
              className="relative w-full py-3 rounded-xl text-[14px] font-semibold text-white transition-all duration-300 mt-2 active:scale-[0.98]"
              style={{
                background: "linear-gradient(135deg, #3B82F6, #06B6D4)",
        ...
        <p
          className="text-center text-[11px] mt-6 font-mono"
          style={{ color: "var(--ink4)" }}
        >
