...
function ThemeInjector() {
  useEffect(() => {
    ...
    el.id = "zynhive-theme";
    if (!document.getElementById("zynhive-theme")) {
      el.textContent = THEME;
      document.head.appendChild(el);
    }
    return () => { document.getElementById("zynhive-theme")?.remove(); };
  }, []);
  return null;
}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <div
          className="font-mono text-[30px] font-black leading-none tracking-tight mb-1.5"
...
function ProjectRow({
  ...
  return (
    <div
      className="flex items-center gap-4 px-5 py-3.5 border-b last:border-0 group transition-all duration-200 cursor-default"
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-0.5">
          ...
          {project.featured && (
            <span
              className="flex-shrink-0 px-1.5 py-0.5 rounded-md text-[8px] font-mono font-bold tracking-widest uppercase text-white"
      ...
      <div className="hidden lg:flex items-center gap-1.5 max-w-[180px] flex-shrink-0">
        ...
        <span
          ...
          style={{ color: "var(--ink3)", fontFamily: "'DM Sans', sans-serif" }}
        >
          {project.result}
        </span>
      </div>
        ...
        {[
          ...
          },
          {
            ...
            icon: (
              <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
                <path
                  d="M1.5 3h8M4 3V1.5h3V3M3.5 3l.5 6.5M7.5 3l-.5 6.5"
                  stroke="currentColor"
                  strokeWidth="1"
                  strokeLinecap="round"
                />
      ...
      >
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path
              d="M3 7h14M8 7V4.5h4V7M6 7l1 11h6l1-11"
              stroke="#EF4444"
              strokeWidth="1.5"
              strokeLinecap="round"
            />
        ...
        >
          "
          <strong style={{ color: "var(--ink3)" }}>{project.title}</strong>
        ...
        <div className="flex gap-3">
          <button
            ...
            onMouseEnter={(e) =>
              ((e.currentTarget as HTMLElement).style.borderColor = "var(--ink4)")
            }
            onMouseLeave={(e) =>
    ...
    <div className="p-6 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {summaryStats.map(({ label, val, color }) => (
          <div
            key={label}
            className="rounded-2xl p-5 text-center relative overflow-hidden transition-all duration-300 hover:-translate-y-0.5"
            style={{ background: "var(--bg-card)", border: "1px solid var(--border2)" }}
          >
            <div
              className="absolute top-0 left-0 right-0 h-px"
            ...
            <div
              className="font-mono text-[9px] tracking-[0.16em] uppercase relative z-10"
      ...
      >
        <h3
          className="font-bold text-[15px] mb-6"
          style={{ color: "var(--ink)", fontFamily: "'DM Sans', sans-serif" }}
        >
        ...
        <div className="flex flex-col gap-2">
          {projects
            ...
            .map((p, i) => (
              <div
                key={p.id}
                className="flex items-center gap-3 p-3 rounded-xl transition-all duration-150 cursor-default"
  ...
  },
  {
    ...
    icon: (
      <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
        ...
        <path
          d="M1 12c0-2.2 1.8-3.5 4-3.5s4 1.3 4 3.5"
          stroke="currentColor"
          strokeWidth="1.1"
          strokeLinecap="round"
        />
        ...
        <path
          d="M13 10.5c0-1.5-.9-2.5-2.2-2.5"
          stroke="currentColor"
          strokeWidth="1.1"
          strokeLinecap="round"
        />
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ background: "var(--bg)", fontFamily: "'DM Sans', sans-serif", cursor: "default" }}
      >
        {/* ── SIDEBAR ────────────────────────────────────────────────────── */}
        <aside
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, transparent, rgba(59,130,246,0.3) 40%, rgba(6,182,212,0.2) 60%, transparent)",
            }}
          />
          ...
          >
            <div className="relative w-8 h-8 flex-shrink-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="font-mono font-black text-[9px]" style={{ color: "#60A5FA" }}>
                  ZH
                </span>
              </div>
            </div>
              ...
              <>
                ...
                >
                  <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                    <path
                      d="M8.5 4.5L11 6.5l-2.5 2M5 6.5h6M5 2H2.5A1 1 0 001.5 3v7a1 1 0 001 1H5"
                      stroke="currentColor"
                      strokeWidth="1.2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <span className="font-mono text-[10px]" style={{ color: "var(--ink4)" }}>
                  <span style={{ color: "#60A5FA", fontWeight: 700 }}>{projects.length}</span>{" "}
                  projects
                </span>
            ...
            {tab === "projects" && (
              <div className="p-6 flex flex-col gap-5">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <StatCard
                    label="Total" value={projects.length} sub="all categories" color={C.accent}
                    icon={
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  ...
                  />
                  <StatCard
                    label="Featured" value={projects.filter((p) => p.featured).length} sub="on homepage" color={C.cyan}
                    icon={
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  ...
                  />
                  <StatCard
                    label="With Images" value={projects.filter((p) => p.imageUrl).length} sub="on Cloudinary" color={C.purple}
                    icon={
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  ...
                  />
                  <StatCard
                    label="AI Projects" value={projects.filter((p) => p.category === "AI Development").length} sub="ML & LLM builds" color={C.gold}
                    icon={
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <div
                    className="ml-auto flex items-center gap-2 px-3 py-1.5 rounded-xl"
                    style={{
                ...
                >
                  ...
                  >
                    <span
                      className="font-mono text-[9px] tracking-[0.18em] uppercase ml-14 flex-1"
                      style={{ color: "var(--ink4)" }}
                    >
                      Project
                    </span>
                    <span
                      className="hidden lg:block font-mono text-[9px] tracking-[0.18em] uppercase max-w-[180px] w-full"
                      style={{ color: "var(--ink4)" }}
                    >
                      Result
                    </span>
                    <span
                      className="w-20 font-mono text-[9px] tracking-[0.18em] uppercase text-right"
                      style={{ color: "var(--ink4)" }}
                    >
                      Actions
                    </span>
                  ...
                  {loading ? (
                    <div className="flex flex-col items-center justify-center py-20 gap-4">
                      <div className="relative w-9 h-9">
                        ...
                        />
                        <div
                          className="absolute inset-0 rounded-full border-2 border-b-transparent animate-spin"
                          style={{
                      ...
                      >
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                          <rect
                            ...
                            stroke="var(--ink4)" strokeWidth="1.5"
                          />
                          <path
                            d="M8 11h6M11 8v6"
                            stroke="#3B82F6"
        ...
        {toast && (
          <div
            ...
            style={{
              background:
                toast.type === "success" ? "var(--bg-card)" : "rgba(30,8,8,0.95)",
              border: `1px solid ${
                toast.type === "success"
                  ? "rgba(59,130,246,0.2)"
                  : "rgba(239,68,68,0.25)"
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow:
                  toast.type === "success" ? "0 0 10px rgba(59,130,246,0.4)" : "none",
              }}
            >
              {toast.type === "success" ? "✓" : "✕"}
            </div>
