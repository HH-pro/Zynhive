  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Featured badge */}
        {project.featured && (
          <div className="absolute top-3 left-3 px-2.5 py-1 rounded-lg text-[9px] font-mono font-bold tracking-widest uppercase text-white"
        ...
        {/* Category badge */}
        <div className="absolute top-3 right-3 px-2.5 py-1 rounded-lg text-[9px] font-mono text-white/85 border border-white/15 backdrop-blur-sm"
      ...
      {/* Content */}
      <div className="p-6">
        <h3 className="font-syne text-[17px] font-bold mb-2 tracking-tight leading-snug" style={{ color: "var(--ink)" }}>
          {project.title}
        </h3>
        <p className="text-[13px] leading-[1.75] font-light mb-4 line-clamp-2" style={{ color: "var(--ink3)" }}>
          {project.description}
        </p>
        ...
        <div className="flex flex-wrap gap-1.5">
          ...
          {project.tags.length > 4 && (
            <span className="font-mono text-[10px] px-2.5 py-1 rounded-lg border"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-20 w-9 h-9 rounded-xl flex items-center justify-center
            transition-all duration-200"
          style={{ background: "var(--bg-surface)", border: "1px solid var(--border2)", color: "var(--ink3)" }}
          onMouseEnter={(e) => {
        ...
        >
          {project.imageUrl ? (
            <img src={getCloudinaryThumb(project.imageUrl, 1400, 512)} alt={project.title}
          ...
          {/* Badges over image */}
          {project.featured && (
            <div className="absolute top-4 left-4 px-2.5 py-1 rounded-lg text-[9px] font-mono font-bold tracking-widest uppercase text-white"
              style={{ background: "linear-gradient(90deg, var(--accent), var(--cyan))" }}>
              Featured
            </div>
          )}
          <div className="absolute top-4 right-14 px-2.5 py-1 rounded-lg text-[9px] font-mono border border-white/20 backdrop-blur-sm"
        ...
        <div className="px-6 sm:px-8 pb-8 -mt-4 relative z-10">
          <div className="flex items-start justify-between gap-4 mb-5">
            <div>
              <h2 className="font-syne text-[24px] sm:text-[28px] font-bold tracking-tight mb-1" style={{ color: "var(--ink)" }}>
                {project.title}
              </h2>
              <span className="font-mono text-[11px]" style={{ color: "var(--ink4)" }}>{project.category}</span>
            </div>
          </div>

          <p className="text-[14px] sm:text-[15px] leading-[1.9] font-light mb-7" style={{ color: "var(--ink3)" }}>
            {project.description}
          </p>
          ...
          <div className="rounded-2xl p-5 mb-7 flex items-center gap-4"
            ...
            <div>
              <div className="font-mono text-[9px] tracking-[0.12em] uppercase mb-1" style={{ color: "var(--ink4)" }}>Key Result</div>
            ...
            <div className="flex flex-wrap gap-3">
              {project.liveUrl && (
                <a href={project.liveUrl} target="_blank" rel="noopener noreferrer"
                  ...
                  style={{ background: `linear-gradient(135deg, ${project.color}, ${project.color}bb)`, boxShadow: `0 4px 20px ${project.color}40` }}>
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
...
export function PortfolioPage() {
  ...
  return (
    <main>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl w-full"
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 mb-6 rounded-full"
            ...
            <span className="w-1.5 h-1.5 rounded-full" style={{ background: "var(--accent)", animation: "bPulse 2s infinite" }}/>
          ...
          <div className="flex flex-wrap gap-2.5 mt-8">
            {[
              ...
              <div key={label}
                ...
                <span className="font-mono text-[10px]" style={{ color: "rgb(255, 255, 255)" }}>{label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── FILTER + GRID ────────────────────────────────────────────────── */}
      <section className="px-4 sm:px-6 lg:px-14 py-16 md:py-24 lg:py-28"
        style={{ background: "var(--bg-base)" }}>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        {p.featured && (
                          <span className="hidden sm:inline px-1.5 py-0.5 rounded text-[8px] font-mono tracking-widest uppercase text-white flex-shrink-0"
                            style={{ background: "linear-gradient(90deg, var(--accent), var(--cyan))" }}>
                            Featured
                          </span>
                        )}
                    ...
                    {/* Arrow */}
                    <div className="flex-shrink-0 transition-all duration-300 group-hover:translate-x-0.5"
